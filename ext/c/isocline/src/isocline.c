...
# include "../lib/attr.c"
# include "../lib/bbcode.c"
# include "../lib/editline.c"
# include "../lib/highlight.c"
# include "../lib/undo.c"
# include "../lib/history.c"
# include "../lib/completers.c"
# include "../lib/completions.c"
# include "../lib/term.c"
# include "../lib/tty_esc.c"
# include "../lib/tty.c"
# include "../lib/stringbuf.c"
