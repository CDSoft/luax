...
If this fails, please try a manual compilation. Contributions on non
supported platforms are welcome.
...
- [lzw](doc/lzw.md): A relatively fast LZW compression algorithm in pure
  Lua
