...
It is based on [LuaX](https://codeberg.org/cdsoft/luax) and uses a pure
Lua library to generate SVG images. It optionally requires
[ImageMagick](https://imagemagick.org/) to make PNG, JPEG or PDF images.

`lsvg` was initially inspired by
[svg-lua](https://github.com/Jericho1060/svg-lua).

## Releases

It is strongly recommended to build Lsvg from source, as this is the
...
- [SVG specifications](https://www.w3.org/TR/SVG12/): if you're brave
  enough...
