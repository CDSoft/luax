...
> F.op.eq(x, y), f.op.ne(x, y), f.op.lt(x, y), f.op.le(x, y), f.op.gt(x,
> y), f.op.ge(x, y).
...
> Returns the list of those elements that satisfy the predicate
> F.op.ueq(x, y), f.op.une(x, y), f.op.ult(x, y), f.op.ule(x, y),
> f.op.ugt(x, y), f.op.uge(x, y).
...
> Returns the list of those elements that satisfy the predicate
> F.op.keq(x, y), f.op.kne(x, y), f.op.klt(x, y), f.op.kle(x, y),
> f.op.kgt(x, y), f.op.kge(x, y).
