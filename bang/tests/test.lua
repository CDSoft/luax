...
section "ls bang/tests"
ls "bang/tests" : foreach(comment)

section "ls bang/tests/*"
ls "bang/tests/*.*" : foreach(comment)

section "ls bang/tests/*.lua"
ls "bang/tests/*.lua" : foreach(comment)

section "ls bang/tests/**"
ls "bang/tests/**" : foreach(comment)

section "ls bang/tests/**.c"
ls "bang/tests/**.c" : foreach(comment)
...
help.epilog "More information at https://codeberg.org/cdsoft/luax"
...
F.foreach(require "luax-targets", function(t)
