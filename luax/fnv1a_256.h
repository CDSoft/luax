...
#ifdef FNV1A_BITINT
typedef unsigned _BitInt(256) t_fnv1a_256;
#else
#ifdef FNV1A_BIT128
typedef uint64_t t_fnv1a_256_digit;
typedef __uint128_t t_fnv1a_256_double_digit;
typedef t_fnv1a_256_digit t_fnv1a_256[256/(8*sizeof(t_fnv1a_256_digit))];
#else
typedef uint32_t t_fnv1a_256_digit;
typedef uint64_t t_fnv1a_256_double_digit;
typedef t_fnv1a_256_digit t_fnv1a_256[256/(8*sizeof(t_fnv1a_256_digit))];
#endif
#endif
