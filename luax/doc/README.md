...
windows-x86           ~/.local/lib/libluax.xyz
```
...
- **[Lua](http://www.lua.org)**: a powerful, efficient, lightweight, embeddable scripting language ([MIT license](http://www.lua.org/license.html))
