...
#ifdef FNV1A_BITINT
typedef unsigned _BitInt(1024) t_fnv1a_1024;
#else
#ifdef FNV1A_BIT128
typedef uint64_t t_fnv1a_1024_digit;
typedef __uint128_t t_fnv1a_1024_double_digit;
typedef t_fnv1a_1024_digit t_fnv1a_1024[1024/(8*sizeof(t_fnv1a_1024_digit))];
#else
typedef uint32_t t_fnv1a_1024_digit;
typedef uint64_t t_fnv1a_1024_double_digit;
typedef t_fnv1a_1024_digit t_fnv1a_1024[1024/(8*sizeof(t_fnv1a_1024_digit))];
#endif
#endif
