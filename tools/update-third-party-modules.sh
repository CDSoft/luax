...
update_lz4()
{
    ...
    unzip -j "$TMP/$LZ4_ARCHIVE" '*/programs/*.[ch]' -d ext/c/lz4/programs
}
...
update_toml()
{
    ...
    patch -p1 <<EOF
diff --git a/ext/lua/toml/toml.lua b/ext/lua/toml/toml.lua
index ef81455..b26e867 100644
--- a/ext/lua/toml/toml.lua
+++ b/ext/lua/toml/toml.lua
