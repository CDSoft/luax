...
phony "promotion" {
    ...
    build "$img/luax-social.png"       {"lsvg", logo, args={1280,  640, F.show(LUAX.URL)}},
    ...
    build "$img/luax-horizontal.png"   {"lsvg", logo, args={7400, 5000, "sky", F.show(LUAX.URL)}},
    build "$img/luax-vertical.png"     {"lsvg", logo, args={5525, 6500, "sky", F.show(LUAX.URL)}},
    build "$img/luax-square.png"       {"lsvg", logo, args={6000, 6000, "sky", F.show(LUAX.URL)}},

    build "$img/luax-yt-banner.png"    {"lsvg", logo, args={2048, 1152, "sky", F.show(LUAX.URL)}},
