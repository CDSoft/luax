...
return function()
    ...
    local expected_traceback = F.case(_VERSION) {
        ["Lua 5.4"] = [[
@$test-luax:tests/luax/luax-tests/lib.lua says: Hello World
Traceback test
stack traceback:
    $test-luax:tests/luax/luax-tests/lib.lua:25: in function 'lib.hello'
    $test-luax:tests/luax/luax-tests/require_test.lua:32: in function 'require_test']],
        ["Lua 5.5"] = [[
@$test-luax:tests/luax/luax-tests/lib.lua says: Hello World
Traceback test
stack traceback:
    $test-luax:tests/luax/luax-tests/lib.lua:25: in field 'hello'
    $test-luax:tests/luax/luax-tests/require_test.lua:32: in function 'require_test']],
    }
