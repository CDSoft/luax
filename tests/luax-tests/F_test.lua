...
do
    ...
    -- Test invalid tables
    local e
    e = F.patch(t, {bool=F.Nil})                    eq({F.validate(schema, e)}, {false, {"bool: missing field"}})
    e = F.patch(t, {bool=""})                       eq({F.validate(schema, e)}, {false, {"bool: boolean expected"}})
    e = F.patch(t, {num=F.Nil})                     eq({F.validate(schema, e)}, {false, {"num: missing field"}})
    e = F.patch(t, {num=""})                        eq({F.validate(schema, e)}, {false, {"num: number expected"}})
    e = F.patch(t, {str=F.Nil})                     eq({F.validate(schema, e)}, {false, {"str: missing field"}})
    e = F.patch(t, {str=42})                        eq({F.validate(schema, e)}, {false, {"str: string expected"}})
    e = F.patch(t, {array=F.Nil})                   eq({F.validate(schema, e)}, {false, {"array: missing field"}})
    ...
    e = F.patch(t, {struct=F.Nil})                  eq({F.validate(schema, e)}, {false, {"struct: missing field"}})
    e = F.patch(t, {struct=42})                     eq({F.validate(schema, e)}, {false, {"struct: shall be a table"}})
    e = F.patch(t, {struct={bool=F.Nil}})           eq({F.validate(schema, e)}, {false, {"struct.bool: missing field"}})
    e = F.patch(t, {struct={bool=""}})              eq({F.validate(schema, e)}, {false, {"struct.bool: boolean expected"}})
    e = F.patch(t, {struct={num=F.Nil}})            eq({F.validate(schema, e)}, {false, {"struct.num: missing field"}})
    e = F.patch(t, {struct={num=""}})               eq({F.validate(schema, e)}, {false, {"struct.num: number expected"}})
    e = F.patch(t, {struct={str=F.Nil}})            eq({F.validate(schema, e)}, {false, {"struct.str: missing field"}})
    e = F.patch(t, {struct={str=42}})               eq({F.validate(schema, e)}, {false, {"struct.str: string expected"}})
    e = F.patch(t, {struct={array=F.Nil}})          eq({F.validate(schema, e)}, {false, {"struct.array: missing field"}})
    e = F.patch(t, {struct={array={8, "9", 10 }}})  eq({F.validate(schema, e)}, {false, {"struct.array[2]: number expected"}})
    e = F.patch(t, {struct={enum=F.Nil}})           eq({F.validate(schema, e)}, {false, {"struct.enum: missing field"}})
    e = F.patch(t, {struct={enum=11}})              eq({F.validate(schema, e)}, {false, {"struct.enum: shall be 10, 100 or 1000"}})
    e = F.patch(t, {struct={range=F.Nil}})          eq({F.validate(schema, e)}, {false, {"struct.range: missing field"}})
    e = F.patch(t, {struct={range="`"}})            eq({F.validate(schema, e)}, {false, {"struct.range: shall be in [\"a\", \"z\"]"}})
    e = F.patch(t, {struct={range="{"}})            eq({F.validate(schema, e)}, {false, {"struct.range: shall be in [\"a\", \"z\"]"}})
    e = F.patch(t, {struct={union=F.Nil}})          eq({F.validate(schema, e)}, {false, {"struct.union: missing field"}})
    ...
    e = F.patch(t, {struct={union={5}}})            eq({F.validate(schema, e)}, {false, {"struct.union: shall be {\"str\", {\"range\", 2, 4}, true}"}})
    e = F.patch(t, {struct={option=9}})             eq({F.validate(schema, e)}, {false, {"struct.option: shall be in [10, 20]"}})
    e = F.patch(t, {struct={option=21}})            eq({F.validate(schema, e)}, {false, {"struct.option: shall be in [10, 20]"}})
    e = F.patch(t, {struct={option=""}})            eq({F.validate(schema, e)}, {false, {"struct.option: number expected"}})
    e = F.patch(t, {struct={any=F.Nil}})            eq({F.validate(schema, e)}, {false, {"struct.any: missing field"}})
    e = F.patch(t, {enum=F.Nil})                    eq({F.validate(schema, e)}, {false, {"enum: missing field"}})
    e = F.patch(t, {enum="why"})                    eq({F.validate(schema, e)}, {false, {"enum: shall be \"yes\", \"no\" or \"maybe\""}})
    e = F.patch(t, {range=F.Nil})                   eq({F.validate(schema, e)}, {false, {"range: missing field"}})
    e = F.patch(t, {range=2})                       eq({F.validate(schema, e)}, {false, {"range: shall be in [3, 8]"}})
    e = F.patch(t, {range=9})                       eq({F.validate(schema, e)}, {false, {"range: shall be in [3, 8]"}})
    e = F.patch(t, {range="4"})                     eq({F.validate(schema, e)}, {false, {"range: number expected"}})
    e = F.patch(t, {union=F.Nil})                   eq({F.validate(schema, e)}, {false, {"union: missing field"}})
