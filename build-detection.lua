...
has.req = fs.findpath "req" ~= nil

-------------------------------------------------------------------------------
-- 32-bit support detection
-------------------------------------------------------------------------------

local test32 = vars%"$cache/test32" -- installed by [ref:lua_bootstrap]

has.x86_support = sh.run { test32, "2>/dev/null" } == true
